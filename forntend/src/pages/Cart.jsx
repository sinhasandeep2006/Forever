              ...
              return (
                <div key={index} className='py-4 border=t border-b text-gray-700 grid grid-col-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
                  <div className="flex items-start gap-6">
                        ...
                        <div className="">
                          <p className="test-xs sm:text-lg font-medium">
                            {productData.name}
                          </p>
        ...
        <div className="flex justify-end my-20">
          <div className="w-full sm:w-[450px]">
            ...
            <div className="w-full text-end">
              <button onClick={()=>navigate('/placeorder')} className='bg-black text-white text-sm my-8 px-8 py-3 hover:cursor-pointer hover:bg-white hover:text-black' >PRORCEED TO CHECKOUT</button>
            </div>
          </div>
        </div>
